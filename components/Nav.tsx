...
export function Nav() {
  ...
  const onDark = pathname !== "/" ? false : false; // hero is white — keep ink text
    ...
    <>
      <motion.header
        ...
        animate={{
          ...
          boxShadow: scrolled ? "0 1px 0 rgba(14,14,14,0.06)" : "0 1px 0 rgba(14,14,14,0)",
          ...
          <div className="flex items-center justify-between h-[104px]">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="flex flex-col leading-none">
                <span className="text-[1.4rem] font-bold tracking-[-0.02em] text-ink leading-none">
                  tabby
                </span>
                <span className="hidden sm:flex items-baseline gap-1.5 mt-1.5 text-[0.62rem] uppercase tracking-[0.2em] font-semibold text-ink/60 leading-none">
                  Launching
                  <span className="font-grotesk italic font-bold text-ink tracking-[-0.01em] text-[0.78rem]">
                    Q4 &apos;26
                  </span>
                </span>
              </span>
            ...
            <nav className="hidden md:flex items-center gap-10 text-[0.95rem] text-ink/80">
              {LINKS.map((l) => (
            ...
            <div className="flex items-center gap-3">
              <div className="relative hidden sm:inline-flex">
                {/* Black Tabby cat peeking up from behind the CTA — head only (receipt cropped).
                    Hidden on /waitlist because the cat peeks from the receipt there instead. */}
                {pathname !== "/waitlist" && (
                  <span
                    aria-hidden
